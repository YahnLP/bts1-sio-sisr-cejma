...
### Partie B – Lire une Lewis fournie (INTERPRÉTER)
...
### Partie C – Polarité et interactions (INTERPRÉTER)
...
### Partie D – Exploitation E2 (ARGUMENTER + DÉCIDER)
